...
lets_play(3)
lets_play(10)
>>>>>>> 024b5d1d2f7c6823d0c000046cd3311465e94c41
```
...
lets_play2 = function(turns, players) {
  ...
  for (j in 1:players) {
    ...
    for (i in 1:turns) {
        ...
        double3data[i] <- lets_move2(double3)[[2]]
      ...
      if (11 %in% location_data[i,j] & "true" %in% double3data[i-1]) { # "true" means player double rolled 3x -> jail
        location <- 11
        location_data[i,j] <- as.integer(location)
      } else if (11 %in% location_data[i-1,j] & "true" %in% double3data[i-2]) { # 
        location <- 11
        location_data[i,j] <- as.integer(location)
      } else if (11 %in% location_data[i-2,j] & "true" %in% double3data[i-3]) {
        location <- 11
        location_data[i,j] <- as.integer(location)
      }
