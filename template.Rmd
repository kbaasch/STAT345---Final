...
lets_play_idk = function(turns, players) {
  ...
  player_bank_data <- data.frame(matrix(nrow = 2, ncol = players))
    ...
    for (i in 2:turns) {
      ...
      # updating banks when players land on each others properties
      ...
      # if location is chance, update amount
        
        
        
 #     if (location %in% chance$space) {
 #     The_Players$Player_Bank[j] <- chance$amount
 #     }
