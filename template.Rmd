...
lets_move = function(location) {
  ...
  #print(dice_roll_1) #tester
  #print(dice_roll_2) #tester
  print(roll_total) #tester
...
lets_play(3) #tester  #in this example if you add up the first three outputs the fourth output should be that sum + 1 to show the movement from location 1 ("GO")
