...
monopolyBoard <- read.csv("MonopolyBoard2.csv", header = T)
head(monopolyBoard)

#monopolyBoard$spaces[2:40] <- monopolyBoard$spaces[2:40] +1

#write.csv(monopolyBoard, "C:\\Users\\oliviabojesen\\Downloads\\MonopolyBoard2.csv") 
