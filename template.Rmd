...
lets_play2 = function(turns, players) {
  ...
  for (j in 1:players) { # rotates through each player
    ...
    for (i in 1:turns) { # iterates through number of turns
      
        location = lets_move2(location)[[1]] # takes location from lets_move2 function and assigns it to location
...
The_Players <- data.frame(Player, Player_Bank)
The_Players

monopolyBoard

Property <- c("Mediterranean", "Baltic", "Reading Railroad", "Oriental", "Vermot", "Connecticut", "St. Charles", "Electriv Company", "States", "Virginia", "Pennsylvania Railroad", "St. James", "Tennessee", "New York", "Kentucky", "Indiana", "Illinios", "B&O Railroad", "Atlantic", "Ventnor", "Water Works", "Marvin Gardens", "Pacific", "N. Carolina", "Pennsylvania", "Short Line Railroad", "Park Place", "Boardwalk")
Property_Status <- c("Unowned")
```
