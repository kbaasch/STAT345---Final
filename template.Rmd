...
#      player_bank_data[j] <- Updating_Player_Bank(location_data[i,j])[[1]]
...
#       owned_by_player <- Updating_Player_Bank(location_data[i,j])[[1]]
#       cost <- Updating_Player_Bank(location_data[i,j])[[2]]
       The_Players$Player_Bank[owned_by_player] <- The_Players$Player_Bank[owned_by_player] + monopolyBoard$rent_0[cost]
       The_Players$Player_Bank[j] <- The_Players$Player_Bank[j] - monopolyBoard$rent_0[cost]
          }
#  return(The_Players)
...
Drawing_Community_Chest(10) # test
