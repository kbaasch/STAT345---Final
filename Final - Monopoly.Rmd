...
lets_play2 = function(turns, players) {
  ...
  #creates frequency plots for landing on each space for each player.
  plot(location_data[,1], xlim = c(0,40), col = "black")
  
  for(k in 2:players){
  lines(location_data[,k], xlim= c(0,40), col=colors[k-1], type="h", xlab="Spaces", ylab="Frequency", main="Frequency of Landing on Each Space for Each Player")
  }
