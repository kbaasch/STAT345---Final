...
The plot, "Density of Landing Locations for All Players", shows the percentage of times each space is landed on for each player. The four colors represent each player.

The plot, "Frequency of Landing Locations Overall", shows how many times each space is landed on for a given player. Since the frequency plots for each player look very similar we decided to only display one.
