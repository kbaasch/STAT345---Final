...
lets_play3 = function(turns, players) {
  ...
  for (k in 2:players) {
    lines(density(location_data[,k]), col = colors[k-1], xlab="Spaces", main= "Density of Landing Locations for all Players") # adds a density line for each player after the first
  }
